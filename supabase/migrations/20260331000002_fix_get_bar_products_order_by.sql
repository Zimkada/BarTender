-- Migration: Fix ORDER BY in get_bar_products to use display_name logic
-- Description: ORDER BY bp.local_name was inconsistent with display_name for products linked to global catalog.
-- Date: 2026-03-31
