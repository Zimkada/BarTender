-- ============================================================================
-- Migration: Update plan member limits (starter 3 → 4)
--
...
BEGIN
  ...
  -- Map plan to max members (NEW LIMITS — starter raised from 3 to 4)
  v_max_members := CASE v_plan
    WHEN 'enterprise' THEN 20
    WHEN 'pro' THEN 8
    ELSE 4  -- starter or unknown
  END;
