-- Migration 064: Fix create_sale_with_promotions function
-- Alignement avec la structure RÉELLE de la table sales

-- Supprimer l'ancienne fonction
DROP FUNCTION IF EXISTS create_sale_with_promotions(UUID, JSONB, TEXT, UUID, TEXT, TEXT, TEXT, TEXT);
DROP FUNCTION IF EXISTS create_sale_with_promotions(UUID, JSONB, UUID, TEXT, TEXT);

-- Créer la fonction avec la signature correcte basée sur la structure réelle
...
FIX 064: Alignement avec la structure RÉELLE de la table sales.';
