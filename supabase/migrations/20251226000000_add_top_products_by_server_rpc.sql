-- MIGRATION: Add get_top_products_by_server RPC function
-- DATE: 2025-12-26
-- PURPOSE: Support server filtering for top products analytics in both simplified and full modes
-- This RPC is used by AnalyticsService.getTopProducts() when a serverId is provided
-- Items are stored as JSONB array in sales table, similar to get_top_products_aggregated
