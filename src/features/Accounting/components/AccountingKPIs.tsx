    ...
    if (viewMode === 'tresorerie') {
        return (
            <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 ${isMobile ? 'mb-4' : 'mb-6'}`}>
                ...
                <div className={`bg-card rounded-2xl border border-border ${isMobile ? 'p-4' : 'p-5'} shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:-translate-y-1 hover:shadow-xl transition-all duration-300 group`}>
                    ...
                    <div className="flex flex-col">
                        <p className={`font-mono font-bold tracking-tighter whitespace-nowrap ${isMobile ? 'text-xl' : 'text-2xl lg:text-xl xl:text-2xl'} ${data.operatingProfit >= 0 ? 'text-foreground' : 'text-red-600'}`}>
                ...
                <div className={`bg-card rounded-2xl border border-border ${isMobile ? 'p-4' : 'p-5'} shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:-translate-y-1 hover:shadow-xl transition-all duration-300 group`}>
                    <div className="flex justify-between items-start mb-4">
                        <div className="flex items-center gap-2">
                            ...
                            <div className="flex flex-col gap-0.5">
                                ...
                                {periodLabel && (
                                    <p className="text-[11px] text-foreground/70 font-bold uppercase tracking-wider">
                                        {periodLabel}
                                    </p>
                                )}
                            </div>
                    ...
                    <div className="flex flex-col">
                        <p className={`font-mono font-bold text-foreground tracking-tighter whitespace-nowrap ${isMobile ? 'text-xl' : 'text-2xl lg:text-xl xl:text-2xl'}`}>
                ...
                {/* Investissements */}
                <div className={`bg-card rounded-2xl border border-border ${isMobile ? 'p-4' : 'p-5'} shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:-translate-y-1 hover:shadow-xl transition-all duration-300 group relative overflow-hidden`}>
                    ...
                    <div className="flex flex-col relative z-10">
                        ...
                        <div className="flex items-center mt-2 gap-2">
                            <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${data.investmentRate > 20 ? 'bg-red-50 text-red-700' : 'bg-gray-100 text-foreground/70'}`}>
    ...
    return (
        <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {/* Solde début */}
                <div className={`bg-card rounded-2xl border border-border ${isMobile ? 'p-4' : 'p-5'} shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:-translate-y-1 hover:shadow-xl transition-all duration-300 group flex flex-col justify-between`}>
                    <div>
                        <div className="flex items-center gap-2 mb-4">
                            <div className="p-2 bg-muted text-muted-foreground rounded-lg group-hover:scale-110 transition-transform">
                                <Calendar size={20} />
                            </div>
                            <h3 className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">
                                Solde début
                    ...
                    {data.previousBalanceDetails && (
                        <div className={`hidden lg:block mt-4 pt-3 border-t border-border space-y-2 ${isMobile ? 'text-[9px]' : 'text-[10px]'} font-medium`}>
                            <div className="flex justify-between items-center text-muted-foreground relative py-0.5">
                ...
                <div className={`bg-card rounded-2xl border border-border ${isMobile ? 'p-4' : 'p-5'} shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:-translate-y-1 hover:shadow-xl transition-all duration-300 group`}>
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <div className="flex flex-col gap-0.5">
                            ...
                            {periodLabel && (
                                <p className="text-[10px] text-foreground/70 font-bold uppercase tracking-wider">
                                    {periodLabel}
                                </p>
                            )}
                        </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className={`mt-2 text-muted-foreground font-medium uppercase tracking-widest ${isMobile ? 'text-[9px]' : 'text-[10px]'}`}>
                            Encaissements
                        </p>
                    </div>
                </div>
                ...
                {/* Solde fin */}
                <div className={`bg-card rounded-2xl border-t-[3px] ${data.finalBalance && data.finalBalance >= 0 ? 'border-t-green-500' : 'border-t-red-500'} border-x border-b border-border ${isMobile ? 'p-4' : 'p-5'} shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:-translate-y-1 hover:shadow-xl transition-all duration-300 group relative overflow-hidden`}>
                    <div className="flex items-center gap-2 mb-4">
                    ...
                    <div className="flex flex-col relative z-10">
                        <p className={`font-mono font-bold tracking-tighter whitespace-nowrap ${isMobile ? 'text-xl' : 'text-2xl lg:text-xl xl:text-2xl'} ${(data.finalBalance || 0) >= 0 ? 'text-foreground' : 'text-red-600'}`}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <div className="bg-card rounded-xl p-4 shadow-sm border border-border flex flex-col justify-between h-full">
                    <p className="text-xs text-muted-foreground font-medium uppercase tracking-wider">Marge Op.</p>
                ...
                <div className="bg-card rounded-xl p-4 shadow-sm border border-border flex flex-col justify-between h-full">
                    <p className="text-xs text-muted-foreground font-medium uppercase tracking-wider">Croissance</p>
                ...
                <div className="bg-card rounded-xl p-4 shadow-sm border border-border flex flex-col justify-between h-full">
                    <p className="text-xs text-muted-foreground font-medium uppercase tracking-wider">Investissement</p>
                    <p className="text-xl font-bold mt-1 text-purple-600">
                        {data.investmentRate.toFixed(1)}%
                    </p>
                </div>
                <div className="bg-card rounded-xl p-4 shadow-sm border border-border flex flex-col justify-between h-full">
                    <p className="text-xs text-muted-foreground font-medium uppercase tracking-wider">Autonomie de trésorerie</p>
