  ...
  public: {
    Tables: {
      ...
      bar_audit_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "bar_audit_log_modified_by_fkey"
            columns: ["modified_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      bar_device_status: {
        ...
        Relationships: [
          {
            foreignKeyName: "bar_device_status_bar_id_fkey"
            columns: ["bar_id"]
            isOneToOne: false
            referencedRelation: "admin_bars_list"
            referencedColumns: ["id"]
      ...
      bar_members: {
        Row: {
          ...
          updated_at: string | null
          user_id: string | null
          virtual_server_name: string | null
        }
        Insert: {
          assigned_at?: string | null
          assigned_by?: string | null
      ...
      bar_product_audit_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "bar_product_audit_log_bar_id_fkey"
            columns: ["bar_id"]
            isOneToOne: false
            referencedRelation: "admin_bars_list"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "bar_product_audit_log_modified_by_fkey"
            columns: ["modified_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      bar_products: {
        Row: {
          ...
          is_source_of_global: boolean | null
      ...
      global_products: {
        Row: {
          ...
          source_bar_product_id: string | null
      ...
      purchase_orders: {
        ...
        Relationships: [
          {
            foreignKeyName: "purchase_orders_bar_id_fkey"
            columns: ["bar_id"]
            isOneToOne: false
            referencedRelation: "admin_bars_list"
            referencedColumns: ["id"]
      ...
      return_audit_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "return_audit_log_modified_by_fkey"
            columns: ["modified_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      returns: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "returns_linked_sale_id_fkey"
          ...
          {
            foreignKeyName: "returns_validated_by_fkey"
      ...
      sales: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "sales_source_return_id_fkey"
      ...
      stock_adjustments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "stock_adjustments_bar_id_fkey"
            columns: ["bar_id"]
            isOneToOne: false
            referencedRelation: "admin_bars_list"
            referencedColumns: ["id"]
      ...
      supplies: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "supplies_reversal_of_id_fkey"
          ...
          {
            foreignKeyName: "supplies_reversed_by_fkey"
            columns: ["reversed_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "supplies_source_purchase_order_id_fkey"
      ...
      tickets: {
        ...
        Relationships: [
          {
            foreignKeyName: "tickets_bar_id_fkey"
            columns: ["bar_id"]
            isOneToOne: false
            referencedRelation: "admin_bars_list"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "tickets_paid_by_fkey"
            columns: ["paid_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      admin_generate_bar_report: { Args: { p_bar_id: string }; Returns: Json }
      admin_get_bar_audit_logs: {
      ...
      approve_return: {
        Args: { p_return_id: string; p_validated_by: string }
        Returns: Json
      }
      assign_bar_member: {
        Args: {
      ...
      calculate_all_dish_costs: { Args: { p_bar_id: string }; Returns: Json }
      calculate_dish_cost: {
      ...
      check_bar_setup_complete: { Args: { p_bar_id: string }; Returns: boolean }
      check_plan_member_limit: {
      ...
      check_user_can_manage_members: {
        Args: { p_action: string; p_bar_id: string; p_user_id: string }
        Returns: boolean
      }
      claim_consignment: {
        Args: { p_claimed_by: string; p_consignment_id: string }
        Returns: Json
      }
      ...
      cleanup_old_heartbeats: {
        ...
        Returns: {
          ...
          oldest_remaining_heartbeat: string
        }[]
      }
      ...
      create_consignment: {
        Args: {
          ...
          p_expires_at?: string
          p_notes?: string
          p_original_seller?: string
          p_product_id: string
          p_product_name: string
          p_product_volume?: string
          p_quantity: number
          p_sale_id: string
          p_server_id?: string
      ...
      internal_get_user_role_for_bar: {
        Args: { p_bar_id: string; p_user_id: string }
        Returns: string
      }
    ...
    Enums: {
      consignment_status: "active" | "claimed" | "forfeited" | "expired"
      event_type:
        | "holiday"
        | "anniversary"
        | "sports"
