      ...
      {isOpen && (
        ...
        >
          <motion.div 
            ...
            className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-lg w-full max-w-4xl max-h-[85vh] md:max-h-[90vh] overflow-y-auto"
          >
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              {totalLots > 0 && (
                <motion.div 
                  ...
                  className="bg-gradient-to-r from-orange-100 to-amber-100 border border-orange-200 rounded-xl p-3"
                >
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    <p className="text-gray-700">Coût total: <span className="text-orange-600 font-semibold">{formatPrice(totalCost)}</span></p>
