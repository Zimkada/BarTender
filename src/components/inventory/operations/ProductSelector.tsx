        ...
        <AnimatePresence>
            ...
            >
                <motion.div
                    ...
                    className="bg-card rounded-2xl shadow-2xl w-full max-w-4xl max-h-[85vh] overflow-hidden flex flex-col"
                >
                    ...
                    <div className="p-4 border-b border-border space-y-3">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-3 bg-muted border border-transparent focus:bg-card focus:border-brand-primary/30 rounded-xl text-sm font-medium shadow-inner transition-all outline-none"
                            />
                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                {filteredProducts.map(product => (
                                    <motion.div
                                        ...
                                        className="bg-muted rounded-xl p-4 border-2 border-border hover:border-brand-primary/30 transition-all"
                                    >
                                        ...
                                        <div className="flex items-center gap-2">
                                            <input
                                                ...
                                                className="w-20 px-3 py-2 bg-card border border-border rounded-lg text-sm font-medium focus:border-brand-primary focus:ring-2 focus:ring-brand-subtle outline-none"
                                            />
                                            <EnhancedButton
                                                variant="primary"
                                                size="sm"
