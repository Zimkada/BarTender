...
const ActiveConsignmentsTab: React.FC = () => {
  ...
  // ✅ SUPPRIMÉ: Effet de remise en stock automatique
  // La logique est maintenant atomique dans useStockManagement (claimConsignment/forfeitConsignment)
  ...
  const handleForfeit = (consignment: Consignment) => {
    ...
    if (success) {
      // ✅ Stock remis automatiquement par useStockManagement.forfeitConsignment
