...
export function SplashScreen({ message = "Chargement de votre bar..." }: SplashScreenProps) {
    return (
        <div className="fixed inset-0 bg-gradient-to-br from-slate-900 to-slate-800 flex flex-col items-center justify-center z-[9999]">
            <motion.div
