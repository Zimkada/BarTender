...
import {
  X, Users, Search, Filter, ChevronLeft, ChevronRight, UserPlus
} from 'lucide-react';
...
import { PromotersCreationForm } from './PromotersCreationForm';
...
export default function UsersManagementPanel({ isOpen, onClose }: UsersManagementPanelProps) {
  ...
  return (
    <>
      ...
      {/* Promoters Creation Form - Outside AnimatePresence */}
