  ...
  return (
    <div className="w-full max-w-2xl mx-auto px-4">
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-h1 text-gray-900 mb-2">Statut de l'équipe</h1>
        ...
        <form onSubmit={handleContinue} className="space-y-5">
          {hasStaff ? (
            <div className="p-5 bg-green-50 border border-green-200 rounded-xl">
              <div className="flex items-start gap-3">
                <span className="w-9 h-9 rounded-lg bg-white text-green-600 flex items-center justify-center font-bold flex-shrink-0">✓</span>
            ...
            <div className="p-5 bg-amber-50 border border-amber-200 rounded-xl">
              <div className="flex items-start gap-3">
                <span className="w-9 h-9 rounded-lg bg-white text-amber-600 flex items-center justify-center font-bold flex-shrink-0">!</span>
                <div className="flex-1 min-w-0">
          ...
          <div className="p-4 bg-gray-50 border border-gray-100 rounded-xl">
            <h3 className="text-body-sm font-semibold text-gray-900 mb-2">À propos des serveurs</h3>
