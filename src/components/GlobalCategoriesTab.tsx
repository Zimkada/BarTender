    ...
    return (
        <div className="h-full flex flex-col p-6">
            <div className="flex justify-between items-center mb-6">
                <h3 className="text-lg font-semibold text-foreground">Liste des Catégories ({categories.length})</h3>
                <Button
            ...
            <div className="flex-1 overflow-y-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {categories.map((category) => (
                        <div
                            key={category.id}
                            className="bg-card p-4 rounded-xl border border-border shadow-sm flex items-center justify-between group hover:shadow-md transition-shadow"
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        ...
                                        />
                                        <span className="text-xs text-muted-foreground">Ordre: {category.orderIndex}</span>
                                    </div>
                                </div>
                            </div>
            ...
            {isModalOpen && (
                ...
                >
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-foreground/80 mb-1">Couleur</label>
