...
export const MANAGE_CONSIGNMENTS_GUIDE: GuideTour = {
  ...
  steps: [
...

    {
      ...
      description:
        '1) Sélectionnez la vente du jour 2) Choisissez le produit à consigner 3) Indiquez la quantité 4) Remplissez les infos client.',
...

    {
      ...
      description:
        'L\'onglet Historique permet d\'auditer toutes les actions passées : créations, récupérations et confiscations, avec les détails clients et gérants.',
      elementSelector: '[data-guide="consignments-history-tab"]',
      position: 'bottom',
      action: 'Terminer',
      tips: [
        '📅 Filtrez par période pour vos bilans stocks',
