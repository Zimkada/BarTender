  ...
  steps: [
...

    {
      ...
      tips: [
        ...
        'Utilisez ces données pour faire le point journalier par serveur, pour motiver et récompenser vos meilleurs éléments',
      ],
    },
...

    {
      ...
      description:
        'Vous maîtrisez maintenant les bases du tableau de bord. N\'hésitez pas à revenir à ce guide à tout moment. Cliquez sur le bouton ? (bouton bleu en bas à droite) pour accéder à tous les guides disponibles.',
      position: 'center',
