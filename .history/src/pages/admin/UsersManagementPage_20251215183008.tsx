              ...
              <table className="w-full min-w-[600px] divide-y divide-gray-200">
                <thead className="bg-white">
                  <tr>
                    ...
                    <th scope="col" className="relative px-2 sm:px-4 md:px-6 py-3 w-28 whitespace-nowrap"> {/* Added w-28 */}
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {users.map(user => (
                    <tr key={user.id}>
                      ...
                      <td className="px-2 sm:px-4 md:px-6 py-4 whitespace-nowrap text-right text-sm font-medium w-28"> {/* Added w-28 */}
