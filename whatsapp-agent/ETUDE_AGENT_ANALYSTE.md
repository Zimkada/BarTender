...
- ~~Le flux exact de l'opt-in (option A, §4) côté application~~ — **conçu le 21/08/2026, migration DB écrite et revue le 22/08/2026 (commits d4c11e5 puis c1f1394 après code review multi-angle, pas encore exécutée), reste à écrire : Edge Function + extension webhook + UI.** Décisions prises (avant écriture du code) :
